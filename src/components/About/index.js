  ...
  return (
    <section className="my-5 about">
      ...
      <p>
        ...
        to build in class projects such as express.js, node.js, react,
        bootstrap, and javascript to taclke down class activies to prepare us
        ...
        succesful Full Stack Software Engineer. Please feel free to get in
        contact with me via email by clicking the icon below.
      </p>
      <div>

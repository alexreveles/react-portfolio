    ...
    <div className="row row-cols-1 row-cols-md-2 g-4">
      <div className="col">
        ...
        <a href="https://happy-happy-tails.herokuapp.com/">
          ...
          <div className="card-body">
            ...
            HTML | CSS | Materialize | JavaScript | Sequelize |<br/> Node.js | Express.js | Handlebars | MySQL | RESTful API | ORM | Heroku | brypt
            </p>
          </div>
        </div>
      </div>
      <div className="col">
        ...
        <a href=" https://alexreveles.github.io/movie-hunt-app/">
          <img src={movieHunt} className="card-img-top" alt="movie-hunt-project" />
          </a>
          <div className="card-body">
            <h5 className="card-title">Movie Hunt</h5>
            <p className="card-text">
            HTML | CSS | Materialize |<br />JavaScript | JQuery|Modal
            </p>
          </div>
        </div>
      </div>
      <div className="col">
        ...
        <a href="https://alexreveles.github.io/run-buddy/">
          <img src={runBuddy} className="card-img-top" alt="run-buddy-project" />
          </a>
          <div className="card-body">
      ...
      <div className="col">
        ...
        <a href="https://alexreveles.github.io/weather-dashboard">
          <img src={weatherDashboard} className="card-img-top" alt="weather-day-project" />
          </a>
          <div className="card-body">
            <h5 className="card-title">Weather Dash Board</h5>
            <p className="card-text">
            HTML | CSS | Bootstrap |<br />JavaScript
            </p>
          </div>
        </div>
      </div>
      <div className="col">
        ...
        <a href="https://alexreveles.github.io/workday-scheduler/">
          <img src={workdaySchedular} className="card-img-top" alt="work-day-project" />
          </a>
          <div className="card-body">
            <h5 className="card-title">Work Day</h5>
            <p className="card-text">
            HTML | CSS | Bootstrap |<br />jQuery | JavaScript
            </p>
          </div>
        </div>
      </div>
